...
import com.kakapp.receiver.AppController;
import com.kakapp.receiver.MediaRendererActivity;
import com.kakapp.receiver.MediaRendererService;
...
public class DefMediaControl {
	...
	public DefMediaControl(Context c) {
		context = c;
	}
	...
	public void init(UnsignedIntegerFourBytes instanceId, LastChange avTransportLastChange, LastChange renderingControlLastChange) {
	...
	synchronized public void setURI(final URI uri) {
		...
		AppController.setUrl(uri.toString());
		try {
	...
	synchronized public void play() {
		...
		AppController.setPlayMode(true);
