...
public class DefAVTransportService extends AbstractAVTransportService {
	...
	public DefAVTransportService(LastChange lastChange, Map<UnsignedIntegerFourBytes, DefMediaControl> players) {
		super(lastChange);
	...
	protected DefMediaControl getInstance(UnsignedIntegerFourBytes instanceId) throws AVTransportException {
